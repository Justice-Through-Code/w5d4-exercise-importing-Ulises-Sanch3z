...
add_song(my_playlist, {"artist": "Lauring Hill", "title": "Everythig Is Everything"})
...
add_song(my_playlist, {'artist': 'NF', 'title': 'Lie'})

add_song(my_playlist, {'artist': 'J Cole', 'title': 'No Role Modelz'})
